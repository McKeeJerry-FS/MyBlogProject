        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    BlogUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ImageData = table.Column<byte[]>(type: "bytea", nullable: true),
                    ContentType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentUpdate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CommentModerated = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CommentDeleted = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CommentModeratedBody = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
